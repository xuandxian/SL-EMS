...
import static com.overtech.ems.picasso.BitmapHunter.forRequest;
import static com.overtech.ems.picasso.Picasso.LoadedFrom.MEMORY;
import static com.overtech.ems.picasso.PicassoDrawable.setBitmap;
import static com.overtech.ems.picasso.PicassoDrawable.setPlaceholder;
import static com.overtech.ems.picasso.Utils.OWNER_MAIN;
import static com.overtech.ems.picasso.Utils.VERB_CHANGED;
import static com.overtech.ems.picasso.Utils.VERB_COMPLETED;
import static com.overtech.ems.picasso.Utils.VERB_CREATED;
import static com.overtech.ems.picasso.Utils.checkMain;
import static com.overtech.ems.picasso.Utils.checkNotMain;
import static com.overtech.ems.picasso.Utils.createKey;
import static com.overtech.ems.picasso.Utils.isMain;
import static com.overtech.ems.picasso.Utils.log;
...
import com.overtech.ems.picasso.RemoteViewsAction.AppWidgetAction;
import com.overtech.ems.picasso.RemoteViewsAction.NotificationAction;
...
public class RequestCreator {
   ...
   */
  public void into(View target, Callback callback) {
    long started = System.nanoTime();
    checkMain();
    ...
    if(target.getTag() == null){
    	if (target instanceof ImageView) {
    		ScaleType scaleType = ((ImageView) target).getScaleType();
    		target.setTag(scaleType);
    	}
    }
    if (!data.hasImage()) {
      picasso.cancelRequest(target);
