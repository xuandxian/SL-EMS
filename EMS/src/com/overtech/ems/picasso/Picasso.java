...
import static com.overtech.ems.picasso.Action.RequestWeakReference;
import static com.overtech.ems.picasso.Dispatcher.HUNTER_BATCH_COMPLETE;
import static com.overtech.ems.picasso.Dispatcher.REQUEST_GCED;
import static com.overtech.ems.picasso.Utils.OWNER_MAIN;
import static com.overtech.ems.picasso.Utils.THREAD_PREFIX;
import static com.overtech.ems.picasso.Utils.VERB_COMPLETED;
import static com.overtech.ems.picasso.Utils.VERB_ERRORED;
...
public class Picasso {
  ...
  final Map<View, DeferredRequestCreator> targetToDeferredRequestCreator;
  ...
  Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
    ...
    this.targetToDeferredRequestCreator = new WeakHashMap<View, DeferredRequestCreator>();
  ...
  void defer(View view, DeferredRequestCreator request) {
  ...
  private void cancelExistingRequest(Object target) {
    ...
    if (target instanceof ImageView) {
      ...
      DeferredRequestCreator deferredRequestCreator =
          targetToDeferredRequestCreator.remove(targetView);
      if (deferredRequestCreator != null) {
          deferredRequestCreator.cancel();
      }
    }
